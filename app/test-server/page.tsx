...
export default async function TestServerPage() {
  try {
    // Get the header list - headers() returns a Promise in Next.js 15
    ...
    console.error("Error in TestServerPage:", err);
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-900 text-white p-4">
        <div className="bg-red-900/50 border border-red-700 rounded p-6 max-w-md">
